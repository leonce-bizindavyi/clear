...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-gray-100 to-yellow-600 bg-opacity-30 ">
  <div className="max-w-screen-xl px-4 py-4 sm:py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid sm:grid-cols-2 gap-8 lg:grid-cols-3">
      ...
      <Link href="/">
        ...
        <p className="max-w-xs mt-4 text-sm text-gray-600">
          Clear Solution your operation&apos;s partner
        </p>
        <div className="socialMedia flex  mt-8 space-x-6 text-gray-600">
      ...
      <div className="grid grid-cols-2 gap-8 lg:col-span-2  lg:grid-cols-4">
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <Link className="hover:opacity-75" href="/"> Conference Room </Link>
            <Link className="hover:opacity-75" href="/"> Automobile Rent </Link>
            <Link className="hover:opacity-75" href="/"> Guest Houses </Link>
          </nav>
        </div>
        <div>
          <p className="font-medium">
