              ...
              <div className="flex flex-col md:flex-row -mx-4">
                ...
                <div className="GrandImage h-64 md:h-[25rem] rounded-lg flex justify-center items-center overflow-hidden mb-4 ">
                    <div
                      ...
                      style={{ display: image === 'img4' ? 'block' : 'none' }}
                    >
                      <Image width={700} height={700} src="/img/img4.jpg" alt="Image 1" className="object-contain h-full w-full" />
                    </div>
    
                    <div
                      className="h-64 md:h-80 rounded-lg   flex items-center justify-center"
                      style={{ display: image === 'img5' ? 'block' : 'none' }}
                    >
                      <Image height={500} width={500} src="/img/img5.jpg" alt="Image 2" className="object-contain h-full w-full" />
                    </div>
                      ...
                      <div className="flex " key={img}>
                        <button
                          ...
                          className={`focus:outline-none rounded-lg ml-4 h-14 md:h-24 w-14 md:w-24  flex items-center justify-center  ${
                            image === img ? 'ring-2 ring-yellow-500 ring-inset' : ''
                          }`}
                        >
                          <Image width={200} height={200} src={`/img/${img}.jpg`} alt={`Image ${img}`} className="object-contain h-full w-full" />
                        </button>
                      </div>
                    ))}
                  </div>
                ...
                <div className="Details md:flex-1 px-8  pt-5 rounded-md shadow-2xl">
                  ...
                  <div className="flex items-center space-x-4 my-4">
                    <div>
                      <div className="rounded-lg  flex py-2 px-3 text-gray-600 font-semibold">
                        <span className="font-bold text-indigo-600 text-3xl poppins-regular">120 000</span>
                  ...
                  <p className="text-gray-600">
                    ...
                    <div class="mt-4 flex space-x-3 overflow-hidden rounded-lg px-1 py-1">
                        <p class="flex items-center font-medium text-gray-800 " title='places'>
                        ...
                        <p class="flex items-center font-medium text-gray-800" title='bathrooms'>
                  ...
                  <div className="flex py-4 space-x-4">
                    <Link href="/provider/my-services/dhdsbkdn23/edit" className="h-14 px-6 py-2 font-semibold rounded-md bg-yellow-600 hover:bg-yellow-500 text-white hover:-translate-y-1 duration-500 transition-all">
                      Edit
                    </Link>
                    <button type="button" className="h-14 px-6 py-2 font-semibold rounded-md bg-black text-white hover:-translate-y-1 duration-500 transition-all">
                      Back
                    </button>
                  </div>
                </div>
