...
function Cards() {
  return (
    <div className="flex gap-5 flex-col sm:flex-row mt-6">
      <div
        className="relative w-full sm:w-[25rem] h-52 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative w-full h-full px-4 sm:px-6 lg:px-4 flex items-center">
          <div>
            ...
            <h3 className="text-white text-3xl mt-2 font-bold">20</h3>
            <h3 className="text-white text-lg mt-2 ">4 in use</h3>
          </div>
        </div>
      </div>

      <div className="cards grid grid-cols-1 gap-5  sm:grid-cols-2 lg:grid-cols-3  w-full ">
        <div className="p-5 bg-white transition-shadow border rounded-lg shadow-sm hover:shadow-lg h-max">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="text-xl poppins-regular font-bold text-gray-800">
                98.500.000 BIF
              </div>
            </div>
          </div>
